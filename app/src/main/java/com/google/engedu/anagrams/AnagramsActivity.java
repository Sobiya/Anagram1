...
public class AnagramsActivity extends AppCompatActivity {
    ...
    public static final String START_MESSAGE = "Find as many words as possible that can be formed by adding at max 2 letters to <big>%s</big> (but that do not contain the substring %s).";
